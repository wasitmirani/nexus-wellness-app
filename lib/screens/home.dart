                          ...
                          SingleChildScrollView(
                            child: Padding(
                              ...
                              child: Column(children: <Widget>[
                               ...
                               SizedBox(height: 10,),
                                Text("Premium plan for you Free- all levels of memberships get access to updated articles, event photos, and products. 0.99 members- get priority for wellness questions to be answered and life skills support class materials"),
                                SizedBox(
                                  height: 10,
                                ),
                                Text("\$9.99 members-get priority for wellness questions to be answered, life skills support class materials, and discounts on event tickets and purple table talk events")
                              ]),
                            ),
                          ),
                        ],
